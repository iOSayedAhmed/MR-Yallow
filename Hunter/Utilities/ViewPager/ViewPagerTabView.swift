...
public final class ViewPagerTabView: UIView {
     ...
     */
    internal func setup(tab:tab, options:ViewPagerOptions , condition:SetupCondition) {
     ...
     */
    fileprivate func setupBasicTab(condition:SetupCondition, options:ViewPagerOptions, tab:tab) {
        ...
        case .distributeNormally:
            ...
            let newFrame = CGRect(x: currentFrame.origin.x, y: currentFrame.origin.y+10, width: labelWidth, height: currentFrame.height-20)
            self.frame = newFrame
            
            // Setting TitleLabel frame
            titleLabel?.frame = CGRect(x: 0, y: 0, width: labelWidth, height: currentFrame.height-20)
        }
     ...
     */
    fileprivate func setupImageTab(condition:SetupCondition, withText:Bool, options:ViewPagerOptions, tab:tab) {
    ...
    internal func updateFrame(atIndex index:Int, withWidth width:CGFloat, options:ViewPagerOptions) {
        ...
        case .basic:
            ...
            titleLabel?.frame = CGRect(x: 0, y: 10, width: self.frame.size.width, height: self.frame.size.height - 20)
    ...
    internal func addHighlight(options:ViewPagerOptions) {
        ...
        self.cornerRadius = options.textCorner
        //self.shadow(2, 0.1)
    }
